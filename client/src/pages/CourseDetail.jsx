...
import { 
  ...
  Heart, Bookmark, MessageSquare, ThumbsUp
} from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                {course.isBestseller && (
                  <span className="inline-block bg-yellow-500 text-black text-xs font-bold px-2 py-1 rounded">BESTSELLER</span>
                )}
                {course.isNew && !course.isBestseller && (
                  <span className="inline-block bg-teal-500 text-white text-xs font-bold px-2 py-1 rounded">NEW</span>
                )}
                <button 
                  onClick={toggleLike}
                  className={`flex items-center gap-1 text-sm ${isLiked ? 'text-pink-500' : 'text-slate-400'} hover:text-pink-500 transition-colors`}
                >
                ...
                <button 
                  ...
                  className={`flex items-center gap-1 text-sm ${isBookmarked ? 'text-teal-400' : 'text-slate-400'} hover:text-teal-400 transition-colors`}
                >
            ...
            <div className="bg-slate-800 rounded-xl overflow-hidden shadow-xl border border-slate-700 transform hover:scale-[1.01] transition-transform duration-300">
              ...
              >
                ...
                />
                <div className={`absolute inset-0 bg-black/40 flex items-center justify-center transition-opacity duration-300 ${videoHover ? 'opacity-100' : 'opacity-90'}`}>
                      ...
                      {[5, 4, 3, 2, 1].map(rating => {
                        ...
                        return (
                          <div key={rating} className="flex items-center gap-2 mb-1 group">
                            ...
                            <div className="w-12 text-right text-sm text-slate-400 group-hover:text-white transition-colors">{percentage}%</div>
                          </div>
                        );
                      })}
                    </div>
                    ...
                    <div className="border-t border-slate-700 pt-6">
                      <div className="flex justify-between mb-2">
                        <div className="flex items-center">
                          ...
                          <div>
                            <h4 className="font-medium hover:text-teal-400 transition-colors">John Doe</h4>
                    ...
                    <div className="border-t border-slate-700 pt-6">
                      <div className="flex justify-between mb-2">
                        <div className="flex items-center">
                          ...
                          <div>
                            <h4 className="font-medium hover:text-teal-400 transition-colors">Alice Smith</h4>
                            <div className="flex text-yellow-400">
                              {[1, 2, 3, 4].map(star => (
                                <Star key={star} className="w-4 h-4 fill-yellow-400" />
                              ))}
