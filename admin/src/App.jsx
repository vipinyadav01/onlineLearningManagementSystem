...
const Toast = ({ message, type = 'success', onClose }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 ${bgColor} text-white p-4 rounded-md shadow-lg z-50 animate-fade-in-out flex items-center`}>
      <span>{message}</span>
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div 
        className={`
          ...
          ${isMobileView 
            ? `${isMobileMenuOpen ? 'left-0' : '-left-64'} w-64` 
            : `${collapsed ? 'w-20' : 'w-64'} left-0`
          }
        `}
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          {(!collapsed || isMobileView) && (
            <h1 className="text-xl font-bold "> TechBit Admin Panel</h1>
          )}
          <button 
            onClick={toggleSidebar}
        ...
        <header className="bg-white shadow-sm py-3 px-4 sticky top-0 z-20">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button className="p-1 rounded-full bg-blue-600 text-white">
